        ...
        if Dict['framework'] == 'tf':
            ...
            if Dict['Pruning']:
                ...
                model = prune_model_tensorflow(model, Dict['pruning_ratio'], Dict['pruning_epochs'],
                                       ...
                                       Dict['Quantization'], Dict['PWInstance'],logger,train_data, train_labels, val_data, val_labels)
            ...
            if Dict['Quantization']:
                print('Qunatization not yet supported for yolo models')
            ...
            if Dict['Pruning']:
                ...
                if Dict['pruning_type'] == 'magnitude_pruning':
                    ...
                    model = prune_dynamic_model_pytorch(model, Dict['pruning_ratio'], Dict['pruning_epochs'],
                                                        Dict['device'], train_loader, val_loader, logger,
                                                        yolo,Dict['PWInstance'])
            ...
            if Dict['Quantization']:
                ...
                if Dict['quantization_type'] == 'Static':
                    model = static_quantize_model_pytorch(model, Dict['desired_format'], Dict['device'], train_loader,Dict['quantization_epochs'],
                                                   logger=logger)
                   ...
                   model = dynamic_quantize_model_pytorch(model, Dict['desired_format'], Dict['device'],logger=logger)
                    ...
                    model = quantization_aware_training_pytorch(model,train_loader,val_loader,Dict['device'],Dict['quantization_epochs'],logger = logger)
